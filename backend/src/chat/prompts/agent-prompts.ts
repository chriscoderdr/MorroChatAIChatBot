...
export const DOCUMENT_AGENT_PROMPT = [
  ...
  '- **Natural Language:** Write responses as if you\'re having a normal conversation about the document content.',
  ...
  '4. Present the information in a clean, conversational way',
  '5. If no relevant information is found, say: "I couldn\'t find information about that in your document."',
