            ...
            <div className="relative max-w-4xl mx-auto flex flex-col gap-2">
                <div className="flex gap-2 items-center">
                    <input
                        ...
                        className="flex-1 bg-gray-800 border border-gray-700 rounded-full py-3 pl-6 pr-16 text-white placeholder-gray-400 focus:outline-none focus:ring-2 focus:ring-blue-500 focus:border-transparent transition-all"
                        disabled={isLoading}
                    />
                    <FileUpload
